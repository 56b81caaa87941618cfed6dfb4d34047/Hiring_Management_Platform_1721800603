...
*/
Vue.component("simple_footer_component_1721800604", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EmployersChoice: Streamlining Recruitment
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Discover top talent effortlessly with our user-friendly platform designed to simplify the hiring process. Get started today and take your team to new heights.
                    </div>
                </div>
            </div>
        </footer> 
